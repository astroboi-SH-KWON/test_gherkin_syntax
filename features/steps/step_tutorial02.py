...
# # https://behave.github.io/behave.example/tutorials/tutorial02.html
...
The thin test automation layer from above (step definitions) just interacts with it. 
The domain model normally preexists (in another Python module/package) and you do not have to write it.
"""
